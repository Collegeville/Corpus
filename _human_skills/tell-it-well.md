...
This is presentation-delivery coaching — the speaker's own voice, slide craft, and stage
presence — refined through low-stakes hobby talks given early in the semester, then generalized
to any talk given afterward, research or otherwise. It's a close companion to
[Presentations That Work]({{ '/human-skills/presentations-that-work/' | relative_url }}), which
covers story structure, scope, and delivery readiness at a planning level, and to
[Slides That Work]({{ '/human-skills/slides-that-work/' | relative_url }}), which covers
deck-building order and content discipline; this skill is specifically about what happens once
you're actually standing up delivering the thing.

## Learning Outcome

After using this technique, you should be able to construct and deliver a short talk that an
audience can actually follow and remember — rather than one that's technically correct but loses
the room.

## Core Structure

1. **Scope: depth over breadth.** Prefer a narrow slice of the topic, covered with real depth,
   over a broad survey of the whole thing. Some topics are simple enough to walk end to end in
   three minutes and still land with the audience; others aren't — and a speaker who tries to
   summarize the whole thing ends up reciting undefined buzzwords the audience can't follow, a
   **talk for experts**, where only people who already knew the material can follow it, defeating
   the point of presenting it at all. Picking one specific mechanic or moment and building real
...
2. **Slides that complement, not repeat.** A slide that exists only to remind the speaker what to
   ...
   slide, impatient by the second, mentally checked out by the third, because the speaker is
   narrating things already read minutes earlier. Prefer slides that complement what's said:
   diagrams for relationships and structure that are clumsy to describe in words, and detailed
   data spoken to at a highlight level — one or two things that matter, with a small story built
   around them, rather than read aloud number by number. For diagrams specifically, step through
   them with a visual cue (a highlight circle around the piece currently being discussed) across a
...
4. **Voice and delivery mechanics.** A speaker with a soft voice should imagine speaking to
   ...
   buy the speaker's mind a moment to catch up without going silent, but a genuine pause does that
   job better; a pause feels uncomfortable to produce but doesn't read as uncomfortable to an
   audience, and if anything tends to increase attentiveness. Uptalk — ending a statement with a
   rising, question-like inflection — is common in everyday speech, but on a statement meant to
   land with impact it tends to read as (and often reflects) a lack of confidence; fix by ending
   statements on an even or slightly downward tone. Vocal fry — a gravelly quality in the voice —
   can make a speaker harder to understand. None of these is something to try fixing live:
...
7. **Closing on key points.** This is, in a sense, the most important thing in the whole talk —
   ...
   Once the key points are set, the rest of the talk exists to build understanding and respect for
   them — anything that doesn't serve that job gets cut, no matter how interesting on its own, and
...
The **talk for experts** failure mode is easiest to see in its original setting: hobby talks, a
3-minute, 3–4 slide presentation on a technical area of the speaker's choice, given early in the
semester before any research-topic stakes exist. A talk on a favorite strategy game that tries to
summarize the entire strategy space — economy, unit counters, map control, matchup theory — ends
up reciting terms that only someone who already plays the game can follow; the audience nods
along without understanding any of it. A talk that instead picks one specific matchup, or one
build order, or one decision point, and walks it end to end — why this opening is strong, what the
opponent's best response is, why the counter to that response works — gives an audience with zero
background in the game something real to take away in the same three minutes. The same contrast
holds for any topic small enough to fit in a short talk: a narrow, deep slice of something
approachable beats a broad, shallow survey of something complex, every time.
...
- [ ] Confidence carries the talk more than note cards do; eyes are on the big screen with the
  audience, not a small screen alone
- [ ] The opening has real enthusiasm, not a flat "my name is / I'm going to talk about"
